...
import (
	...
	"leapp_daemon/interface/http_controller/dto/request_dto/aws_iam_role_federated_session_request_dto"
...
func (controller *EngineController) GetAwsIamRoleFederatedSession(context *gin.Context) {
	...
	requestDto := aws_iam_role_federated_session_request_dto.AwsGetIamRoleFederatedSessionRequestDto{}
...
func (controller *EngineController) CreateAwsIamRoleFederatedSession(context *gin.Context) {
	...
	requestDto := aws_iam_role_federated_session_request_dto.AwsCreateIamRoleFederatedSessionRequestDto{}
	err := (&requestDto).Build(context)
	if err != nil {
		_ = context.Error(err)
		return
...
func (controller *EngineController) EditAwsIamRoleFederatedSession(context *gin.Context) {
	...
	requestUriDto := aws_iam_role_federated_session_request_dto.AwsEditIamRoleFederatedSessionUriRequestDto{}
	...
	requestDto := aws_iam_role_federated_session_request_dto.AwsEditIamRoleFederatedSessionRequestDto{}
	err = (&requestDto).Build(context)
	if err != nil {
		_ = context.Error(err)
		return
...
func (controller *EngineController) DeleteAwsIamRoleFederatedSession(context *gin.Context) {
	...
	requestDto := aws_iam_role_federated_session_request_dto.AwsDeleteIamRoleFederatedSessionRequestDto{}
	err := (&requestDto).Build(context)
	if err != nil {
		_ = context.Error(err)
		return
...
func (controller *EngineController) StartAwsIamRoleFederatedSession(context *gin.Context) {
	...
	requestDto := aws_iam_role_federated_session_request_dto.AwsStartIamRoleFederatedSessionRequestDto{}
	err := (&requestDto).Build(context)
	if err != nil {
		_ = context.Error(err)
		return
...
func (controller *EngineController) StopAwsIamRoleFederatedSession(context *gin.Context) {
	...
	requestDto := aws_iam_role_federated_session_request_dto.AwsStopIamRoleFederatedSessionRequestDto{}
	err := (&requestDto).Build(context)
	if err != nil {
		_ = context.Error(err)
		return
