...
import (
	...
	"leapp_daemon/infrastructure/gcp"
...
func GetGcpOauthUrl(context *gin.Context) {
	// swagger:route GET /gcp/session/plain/oauth/url
	...
	responseDto := response_dto.GcpOauthUrlResponse{
		Message: "success",
		Data:    url,
	}
...
func GetGcpPlainSession(context *gin.Context) {
	...
	responseDto := response_dto.GcpGetPlainSessionResponse{
		Message: "success",
