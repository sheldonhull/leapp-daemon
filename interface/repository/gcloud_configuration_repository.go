...
type GcloudAccessTokensTable interface {
...
type GcloudConfigurationRepository struct {
  ...
  AccessTokensTable GcloudAccessTokensTable
}
...
func (repo *GcloudConfigurationRepository) getGcloudConfigFilePath() (string, error) {
...
func (repo *GcloudConfigurationRepository) getGcloudAccessTokensDbFilePath() (string, error) {
  configDir, err := repo.gcloudConfigDir()
  if err != nil {
    return "", err
  }
...
func (repo *GcloudConfigurationRepository) RemoveAccessTokensFromDb(accountId string) error {
