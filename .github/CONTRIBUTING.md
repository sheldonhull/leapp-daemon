...
Please send a [GitHub Pull Request to leapp-daemon](https://github.com/noovolari/leapp-daemon/pull/new/master) with a clear list of what you've done (read more about [pull requests](http://help.github.com/pull-requests/)). 
